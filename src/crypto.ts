...
export async function importPubKey(
  ...
  return await webcrypto.subtle.importKey("spki", keyData, {
    name: "RSA-OAEP",
    hash: "SHA-256",
...
export async function importPrvKey(
  ...
  const keyData = base64ToArrayBuffer(strKey);
  return await webcrypto.subtle.importKey("pkcs8", keyData, {
    name: "RSA-OAEP",
    hash: "SHA-256",
  } as any, false, ["decrypt"]);
}
...
export async function importSymKey(
  ...
  const keyData = base64ToArrayBuffer(strKey);
  return await webcrypto.subtle.importKey("raw", keyData, {
    name: "AES-GCM",
  } as any, false, ["encrypt", "decrypt"]);
}
